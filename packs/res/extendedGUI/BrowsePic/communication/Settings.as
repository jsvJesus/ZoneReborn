package communication
{
   ...
   public class Settings extends EventDispatcher
   {
      ...
      public static function ApplyDefaultSettings() : void
      {
      }
      ...
      protected static function onGetSettingsRangeHandler(event:ApiEvent) : void
      {
         ...
         Logger.LogToChannel(Logger.DEBUG,"Settings.onGetSettingsRangeHandler",event.data.answer,event.data.error);
         dispatchReadyState();
      }
