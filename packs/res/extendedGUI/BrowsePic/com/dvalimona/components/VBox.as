      ...
      protected function doAlignment() : void
      {
         ...
         if(this._alignment != NONE)
         {
            for(i = 0; i < numChildren; i++)
            {
               ...
               {
                  child.x = _width - child.width - paddingRight;
               }
               ...
               {
                  child.x = !!child.hasOwnProperty("paddingLeft") ? Number((child as Object).paddingLeft) : 0;
                  child.width = _width - (!!child.hasOwnProperty("paddingLeft") ? (child as Object).paddingLeft : 0) - (!!child.hasOwnProperty("paddingRight") ? (child as Object).paddingRight : 0);
               }
            }
         }
      }
