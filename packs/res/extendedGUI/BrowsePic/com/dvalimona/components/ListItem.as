package com.dvalimona.components
{
   ...
   public class ListItem extends Component
   {
      ...
      {
         super.addChildren();
         this._label = new Label(this,20,7);
         this._label.color = 0;
         this._label.size = 20;
         this._label.draw();
      }
      ...
      override public function draw() : void
      {
         ...
         {
            graphics.beginFill(this._defaultColor,1);
         }
         ...
         else if(Boolean(this._data.hasOwnProperty("label")) && this._data.label is String)
         {
      ...
      {
         super.removeEventListener(MouseEvent.MOUSE_OUT,this.onMouseOut);
