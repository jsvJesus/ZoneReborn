package communication
{
   ...
   public class ScreenMode extends EventDispatcher
   {
      ...
      public function ScreenMode(param1:IEventDispatcher = null)
      {
         super(param1);
      }
      ...
      protected static function onUpdateModeHandler(param1:ApiEvent) : void
      {
         Logger.LogToChannel(Logger.WARNING,"onUpdateModeHandler",param1.data.answer.state);
         if(param1.data.answer.state != null)
         {
            self.state = param1.data.answer.state;
            Settings.self.addEventListener(Settings.READY,onSettingsReady);
            Settings.UpdateData();
         }
      }
      
      protected static function onSettingsReady(param1:Event) : void
      {
