package com.greensock
{
   ...
   public class TimelineMax extends TimelineLite implements IEventDispatcher
   {
      ...
      public function tweenFromTo(param1:*, param2:*, param3:Object = null) : TweenLite
      {
         ...
         return _loc4_.duration(Math.abs(_loc4_.vars.time - param1) / _timeScale || 0.001) as TweenLite;
      }
      ...
      override public function render(param1:Number, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         var _loc11_:int = int(this._cycle);
         if(param1 >= _loc4_)
         {
            if(!this._locked)
            {
         ...
         if(this._cycle != _loc11_)
         {
            if(!this._locked)
            {
               ...
               if(_loc20_)
               {
                  _loc5_ = _loc19_ ? _duration + 0.0001 : -0.0001;
      ...
      {
         return !arguments.length ? _time / duration() : totalTime(duration() * (Boolean(this._yoyo) && (this._cycle & 1) !== 0 ? 1 - param1 : param1) + this._cycle * (_duration + this._repeatDelay),param2);
      }
