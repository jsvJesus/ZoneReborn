package com.greensock
{
   ...
   public class TimelineLite extends SimpleTimeline
   {
      ...
      protected function _parseTimeOrLabel(param1:*, param2:* = 0, param3:Boolean = false, param4:Object = null) : Number
      {
         ...
         param2 ||= 0;
         if(typeof param1 === "string" && (Boolean(isNaN(param1)) || param1 in this._labels))
         {
      ...
      {
         return totalTime(typeof param1 === "number" ? Number(param1) : Number(this._parseTimeOrLabel(param1)),param2);
      }
      ...
      public function getTweensOf(param1:Object, param2:Boolean = true) : Array
      {
         ...
         while(--_loc7_ > -1)
         {
            if(_loc6_[_loc7_].timeline === this || param2 && Boolean(this._contains(_loc6_[_loc7_])))
            {
               var _loc8_:*;
