package com.dvalimona.components
{
   ...
   public class ScrollBar extends Component
   {
      ...
      protected var _hideButtons:Boolean = false;
      ...
      public function set hideButtons(param1:Boolean) : void
      {
         this._hideButtons = param1;
         invalidate();
      }
      ...
      override protected function addChildren() : void
      {
         ...
         this._upButton.setSize(this.size,this.size);
         ...
         this._downButton.setSize(this.size,this.size);
      ...
      override public function draw() : void
      {
         ...
         {
            if(this.contains(this._upButton))
            {
               this.removeChild(this._upButton);
            }
            if(this.contains(this._downButton))
            {
               this.removeChild(this._downButton);
            }
         }
         else
         {
         ...
         if(this._orientation == Slider.VERTICAL)
         {
            ...
            this._scrollSlider.y = !!this._hideButtons ? 0 : this.size;
            this._scrollSlider.width = this.size;
            this._scrollSlider.height = _height - (!!this._hideButtons ? 0 : this.size * 2);
            this._upButton.setSize(this.size,this.size);
            this._downButton.setSize(this.size,this.size);
            this._downButton.x = 0;
            this._downButton.y = _height - this.size;
         }
         else
         {
            this._scrollSlider.x = this.size;
            this._scrollSlider.y = 0;
            this._scrollSlider.width = _width - this.size * 2;
            this._scrollSlider.height = this.size;
            this._downButton.x = _width - this.size;
...
class ScrollSlider extends Slider
{
   ...
   override protected function drawHandle() : void
   {
      ...
      if(_orientation == HORIZONTAL)
      {
         ...
         _handle.graphics.beginFill(Style.BUTTON_UP);
      ...
      else
      {
         ...
         _handle.graphics.beginFill(0,0.5);
         _handle.graphics.drawRect(0,0,_width,_loc1_);
         _handle.graphics.endFill();
         _handle.graphics.beginFill(Style.SLIDER_HANDLE_COLOR);
