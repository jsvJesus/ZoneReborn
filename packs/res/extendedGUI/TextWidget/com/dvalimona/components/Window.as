package com.dvalimona.components
{
   ...
   public class Window extends Component
   {
      ...
      protected function _onAddedToStageHandler(param1:Event) : void
      {
      ...
      override protected function addChildren() : void
      {
         ...
         while(_loc1_ < 4)
         {
            ...
            this._grips.graphics.moveTo(0,3 + _loc1_ * 4);
            this._grips.graphics.lineTo(100,3 + _loc1_ * 4);
            this._grips.graphics.lineStyle(1,0,0.125);
            this._grips.graphics.moveTo(0,4 + _loc1_ * 4);
            this._grips.graphics.lineTo(100,4 + _loc1_ * 4);
            _loc1_++;
         }
      ...
      {
         trace("onMouseGoDown",this._draggable);
         if(this._draggable)
         {
            this.startDrag();
      ...
      {
         trace("onMouseGoUp",this._draggable);
         this.stopDrag();
      ...
      public function set titleBar(param1:BlackPanel) : void
      {
