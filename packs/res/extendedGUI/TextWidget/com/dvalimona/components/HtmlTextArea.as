package com.dvalimona.components
{
   ...
   public class HtmlTextArea extends HtmlText
   {
      ...
      public function HtmlTextArea(param1:DisplayObjectContainer = null, param2:Number = 0, param3:Number = 0, param4:String = "")
      {
      ...
      {
         Logger.LogToChannel(Logger.WARNING,"htmlTA mouseWheel",param1.delta);
