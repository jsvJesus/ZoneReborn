package com.dvalimona.components
{
   ...
   public class TextShadowed extends Text
   {
      ...
      public function TextShadowed(param1:DisplayObjectContainer = null, param2:Number = 0, param3:Number = 0, param4:String = "")
      {
      ...
      override public function set size(param1:uint) : void
      {
         _format.size = param1;
         this._shadowFormat.size = param1;
         invalidate();
      }
      
      override public function set leading(param1:uint) : void
      {
         _format.leading = param1;
         this._shadowFormat.leading = param1;
         invalidate();
      }
