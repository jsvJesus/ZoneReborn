package ui
{
   ...
   public class Footer extends Sprite
   {
      ...
      public function set serverName(param1:String) : *
      {
         this.server.text = param1;
         setTimeout(this.onResize,1000);
      }
      
      protected function onGetClientVersionHandler(param1:ApiEvent) : void
      {
         Logger.LogToChannel(Logger.WARNING,"onGetClientVersionHandler",param1.data.answer.result);
         this.version.text = param1.data.answer.result + "";
         this.draw();
      }
      ...
      protected function draw() : void
      {
         ...
         this.server.width = this.server.textField.textWidth;
