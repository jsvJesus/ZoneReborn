package scaleform.clik.controls
{
   ...
   public class CoreListChannel extends UIComponent
   {
      ...
      public function CoreListChannel()
      {
         super();
      }
      ...
      override protected function draw() : void
      {
         ...
         if(!this._usingExternalRenderers && isInvalid(InvalidationType.RENDERERS))
         {
            if(this._renderers != null)
            {
               if(this.dataProvider.length <= this._renderers.length)
               {
      ...
      protected function drawRenderers(total:Number) : void
      {
         ...
         if(this._totalRenderers >= this.dataProvider.length)
         {
            this._totalRenderers = this.dataProvider.length;
         }
