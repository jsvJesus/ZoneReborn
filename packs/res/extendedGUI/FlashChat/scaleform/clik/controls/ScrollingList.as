   ...
   public class ScrollingList extends CoreList
   {
      ...
      override protected function drawLayout() : void
      {
         ...
         for(var i:uint = 0; i < l; i++)
         {
            ...
            {
               renderer.textField.textColor = this._dataArray[i].color;
               renderer.setcomField(this._dataArray[i].id,this._dataArray[i].com,this._dataArray[i].color);
               renderer.addEventListener(ListEvent.ITEM_CLICK,this.onRenderClick);
            }
            if(!dataWillChange)
            {
      ...
      protected function onRenderClick(e:ListEvent) : *
      {
         dispatchEvent(new ListEvent(ListEvent.ITEM_CLICK,false,true,e.index));
      }
      ...
      protected function populateData(data:Array) : void
      {
         ...
         for(var i:uint = 0; i < l; i++)
         {
            ...
            listData = new ListDataSO(index,itemToLabel(data[i]),_selectedIndex == index);
