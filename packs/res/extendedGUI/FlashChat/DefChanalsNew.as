package
{
   ...
   public dynamic class DefChanalsNew extends MovieClip
   {
      public var Channels:ChannelList;
      
      public var sb:DefaultScrollBar;
      
      public function DefChanalsNew()
      {
         super();
         this.__setProp_Channels_DefChanalsNew_Слой1_0();
         this.__setProp_sb_DefChanalsNew_Слой1_0();
      }
      
      internal function __setProp_Channels_DefChanalsNew_Слой1_0() : *
      {
         try
         {
         ...
         this.Channels.itemRendererName = "ChanalCheckBox";
      ...
      internal function __setProp_sb_DefChanalsNew_Слой1_0() : *
      {
         try
         {
