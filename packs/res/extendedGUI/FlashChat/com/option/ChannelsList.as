package com.option
{
   ...
   import scaleform.clik.controls.CoreListChannel;
   ...
   public class ChannelsList extends CoreListChannel
   {
      ...
      override public function handleInput(event:InputEvent) : void
      {
         ...
         var renderer:MovieClip = getRendererAt(_selectedIndex,this._scrollPosition);
         if(renderer != null)
         {
      ...
      {
         dispatchEvent(new ColorEvent(ColorEvent.SHOW,e.color,e.index,e.id));
      }
      ...
      protected function updateScrollBar() : void
      {
         ...
         {
            scroll = this._scrollBar as ScrollBar;
            scroll.setScrollProperties(_dataProvider.length - _totalRenderers,0,_dataProvider.length - _totalRenderers);
         }
      ...
      public function getChannels() : Array
      {
         ...
         {
            arr.push({
               "id":dataProvider[i].id,
               "label":dataProvider[i].label,
               "selected":dataProvider[i].selected,
               "com":dataProvider[i].com
            });
         }
         return arr;
      }
      ...
      override protected function updateSelectedIndex() : void
      {
         ...
         var renderer:MovieClip = getRendererAt(_selectedIndex,this.scrollPosition);
         if(renderer != null)
         {
      ...
      protected function populateData(data:Array) : void
      {
         ...
         var l:uint = _renderers.length;
         if(data.length <= _renderers.length)
         {
            l = data.length;
         }
         else
