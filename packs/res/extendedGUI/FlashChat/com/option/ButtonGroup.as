package com.option
{
   ...
   public class ButtonGroup extends EventDispatcher
   {
      ...
      public var selectedButton:CheckBox;
      ...
      public function getButtonAt(index:int) : CheckBox
      {
         return this._children[index] as CheckBox;
      }
      
      public function setSelectedButtonByIndex(index:uint, selected:Boolean = true) : Boolean
      {
         var success:Boolean = false;
         var btn:CheckBox = this._children[index] as CheckBox;
         if(btn != null)
         {
      ...
      protected function updateSelectedButton(button:CheckBox, selected:Boolean = true) : void
      {
         ...
         var oldButton:CheckBox = this.selectedButton;
         if(selected)
         {
      ...
      public function hasButton(button:CheckBox) : Boolean
      {
      ...
      {
         return "[CLIK CheckBoxGroup " + this.name + " (" + this._children.length + ")]";
      }
      
      protected function handleSelect(event:Event) : void
      {
         var button:CheckBox = event.target as CheckBox;
         if(button.selected)
         {
            this.updateSelectedButton(button,true);
         }
      ...
      {
         this.removeButton(event.target as CheckBox);
      }
   }
}
