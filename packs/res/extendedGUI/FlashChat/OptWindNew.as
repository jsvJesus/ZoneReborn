package
{
   ...
   public dynamic class OptWindNew extends OptWindow
   {
      public function OptWindNew()
      {
         super();
         this.__setProp_BackChatSlider_OptWindNew_buttons_0();
         this.__setProp_BackGameSlider_OptWindNew_buttons_0();
         this.__setProp_FontSlider_OptWindNew_buttons_0();
      }
      
      internal function __setProp_BackChatSlider_OptWindNew_buttons_0() : *
      {
         try
         {
      ...
      internal function __setProp_BackGameSlider_OptWindNew_buttons_0() : *
      {
         try
         {
      ...
      internal function __setProp_FontSlider_OptWindNew_buttons_0() : *
      {
         try
         {
