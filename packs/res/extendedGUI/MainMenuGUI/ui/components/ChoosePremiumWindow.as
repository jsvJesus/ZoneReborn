package ui.components
{
   ...
   public class ChoosePremiumWindow extends Component
   {
      ...
      public function ChoosePremiumWindow(parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number = 0)
      {
      ...
      {
         var tHeight:uint = HeaderHeight + 1 + ButtonsHeight + ItemHeight * (Premium.list.length > NumVisibleItemsMax ? NumVisibleItemsMax : Premium.list.length);
         this.setSize(800,tHeight);
      }
      ...
      protected function onPremiumSelected(event:Event) : void
      {
      ...
      protected function onPremiumSuccess(event:Event) : void
      {
         this.buy.enabled = false;
      ...
      protected function onPremiumFail(event:Event) : void
      {
         this.buy.enabled = false;
         Premium.core.removeEventListener(Premium.SUCCESS,this.onPremiumSuccess);
         Premium.core.removeEventListener(Premium.FAIL,this.onPremiumFail);
      ...
      private function doClose() : void
      {
         ...
         tl.staggerFromTo([this,this.back,this.topBox,this.list,this.bottomBox].reverse(),0.3,{
            "alpha":1,
            "z":0,
            "ease":Expo.easeOut
         },{
      ...
      protected function get buyButtonText() : String
      {
         ...
         if(this.list.selectedItem != null)
         {
            ...
            {
               result = Locale.getById("extendedGUI.PremiumPanel.buy") + " «" + this.list.selectedItem.caption + "» " + Locale.getById("extendedGUI.PremiumPanel.for") + " " + this.list.selectedItem.price + " " + Locale.getById("extendedGUI.PremiumPanel.gold");
            }
            else
            {
               result = Locale.getById("extendedGUI.PremiumPanel.alreadyHavePremium") + " «" + Premium.Current.caption + "»";
            }
         }
         else
         {
            result = Premium.Current == null ? Locale.getById("extendedGUI.PremiumPanel.buy") : Locale.getById("extendedGUI.PremiumPanel.alreadyHavePremium") + " «" + Premium.Current.caption + "»";
         }
         return result;
      }
