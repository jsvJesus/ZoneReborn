   ...
   public class Button extends UIComponent
   {
      ...
      public function set selected(value:Boolean) : void
      {
         ...
         if(this.enabled)
         {
            ...
            {
               _displayFocus = Boolean(this._selected) && this.owner != null && Boolean(this.checkOwnerFocused());
      ...
      protected function handleMouseRollOut(event:MouseEvent) : void
      {
         ...
         if(event.buttonDown)
         {
            ...
            if(Boolean(this._mouseDown & 1 << index))
            {
               if(stage != null)
               {
                  addEventListener(MouseEvent.MOUSE_UP,this.handleReleaseOutside,false,0,true);
               }
            }
      ...
      protected function handleReleaseOutside(event:MouseEvent) : void
      {
         ...
         removeEventListener(MouseEvent.MOUSE_UP,this.handleReleaseOutside,false);
         this._mouseDown ^= 1 << mouseIdx;
      ...
      {
         if(Boolean(this._toggle) && (!this.selected || this.allowDeselect))
         {
