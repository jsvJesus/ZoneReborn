package scaleform.clik.core
{
   ...
   public class UIComponent extends MovieClip
   {
      ...
      public var _displayFocus:Boolean = false;
      ...
      {
         var w:Number = this._width == 0 ? this.actualWidth : Number(this._width);
         var h:Number = this._height == 0 ? this.actualHeight : Number(this._height);
      ...
      protected function isInvalid(... invalidTypes) : Boolean
      {
         ...
         var l:uint = uint(invalidTypes.length);
         if(l == 0)
         {
