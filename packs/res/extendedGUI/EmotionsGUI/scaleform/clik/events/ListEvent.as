package scaleform.clik.events
{
   ...
   public class ListEvent extends Event
   {
      ...
      public var itemRenderer:MovieClip;
      ...
      public function ListEvent(type:String, bubbles:Boolean = false, cancelable:Boolean = true, index:int = -1, columnIndex:int = -1, rowIndex:int = -1, itemRenderer:MovieClip = null, itemData:Object = null, controllerIdx:uint = 0, buttonIdx:uint = 0, isKeyboard:Boolean = false)
      {
