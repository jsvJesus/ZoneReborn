package com.dvalimona.components
{
   ...
   public class PushButton extends Component
   {
      ...
      private function alignLeft() : void
      {
         ...
         if(this._label.width > width - padding * 2)
         {
            this._label.width = width - padding * 2;
         }
         this._label.draw();
         this._label.move(padding,_height / 2 - this._label.height / 2);
      }
      ...
      private function alignRight() : void
      {
         ...
         this._label.draw();
         this._label.move(width - this._label.width - padding,_height / 2 - this._label.height / 2);
      }
