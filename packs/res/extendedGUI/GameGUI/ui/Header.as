package ui
{
   ...
   public class Header extends Sprite
   {
      ...
      protected function draw() : void
      {
         ...
         this.debugBtnsBox.x = Base.self.stage.stageWidth - this.debugBtnsBox.width - 10;
         this.languageSelector.x = Base.self.stage.stageWidth - this.languageSelector.width - sideMargin;
      ...
      private function drawBackground() : void
      {
         ...
         this.background.graphics.drawRect(0,0,Base.self.stage.stageWidth,Navigator.HEADER_HEIGHT);
