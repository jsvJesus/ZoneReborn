package com.dvalimona.components
{
   public class Style
   {
      ...
      {
         return FontLoader.getLightFontName();
      }
      
      public static function get fontName() : String
      {
         return FontLoader.getRegularFontName();
      }
      
      public static function get boldFontName() : String
      {
         return FontLoader.getBoldFontName();
      }
      
      public static function get blackFontName() : String
      {
         return FontLoader.getBlackFontName();
      }
