package com.dvalimona.components
{
   ...
   public class PushButton extends Component
   {
      ...
      public function PushButton(parent:DisplayObjectContainer = null, xpos:Number = 0, ypos:Number = 0, label:String = "", defaultHandler:Function = null, _$:String = "")
      {
         if(Boolean(_$.length))
         {
            this.$ = _$;
      ...
      {
         trace("updateLocalized",this,this.$,this.label);
         var oldAlpha:Number = this.alpha;
         this.label = Localization.GET(this.$);
      }
