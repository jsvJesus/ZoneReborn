package com.controls
{
   ...
   public class CheckBox extends UIComponent
   {
      ...
      protected var _unselected:Boolean = false;
      ...
      protected var statesUnselected:Vector.<String> = Vector.<String>(["unselected_",""]);
      ...
      public function setListData(param1:ListDataChan) : void
      {
      ...
      public function get unselected() : Boolean
      {
      ...
      {
         if(this._unselected == param1)
         {
            return;
         }
         this._unselected = param1;
         if(this.enabled)
         {
            if(!this.owner)
            {
