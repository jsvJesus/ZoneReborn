package logging
{
   ...
   public class Logger extends Sprite
   {
      ...
      public static function Re(o:Object, prefix:String = ">\t\t") : void
      {
         var i:String = null;
         for(i in o)
         {
            Logger.LogToChannel(Logger.DEBUG,prefix,i,":",o[i]);
            Re(o[i],prefix + "\t");
         }
      }
      ...
      private static function initTextField(defaultShow:Boolean = false) : void
      {
         ...
         var tformat:TextFormat = new TextFormat("Arial",12,16777215,true);
         tformat.tabStops = [100,200];
      ...
      public static function set regPoint(value:Point) : void
      {
         _regPoint = value;
         printLog();
      }
