package
{
   ...
   import communication.Character;
   import communication.Gold;
   import communication.Premium;
   ...
   public class Base extends Sprite
   {
      ...
      public static const VERSION:String = "1.2.150626";
      ...
      public function initFirst() : void
      {
         ...
         this.initPool = [this.initStage,this.initLogger,this.initKeyboard,this.initMouse,this.initCommunication,this.initEntities,this.initLocales];
