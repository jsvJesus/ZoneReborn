class gfx.controls.NumericStepper extends gfx.core.UIComponent
{
   ...
   {
      var _loc2_ = Math.max(this._minimum,Math.min(this._maximum,this.stepSize * Math.round(value / this.stepSize)));
      return _loc2_;
   }
   function updateLabel()
   {
      var _loc2_ = this._value.toString();
      if(this._labelFunction != null)
      {
         _loc2_ = this._labelFunction(this._value);
      }
